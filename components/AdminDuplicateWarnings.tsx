...
import { MapPin, FileWarning, ExternalLink } from 'lucide-react';
import {
  CASE_DETAIL_FIELDS,
 ...
 */
export default function AdminDuplicateWarnings({ record }: { record: any }) {
  ...
  if (settlementMatches.length === 0 && signatureDiffs.length === 0) return null;
