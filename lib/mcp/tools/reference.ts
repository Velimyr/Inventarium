...
export function registerReferenceTools(server: McpServer) {
  server.registerTool(
    'list_archives',
    {
      ...
      description:
        'Довідник архівів і бібліотек: скорочена назва (як у шифрі справи), повна назва, країна, сайт. ' +
        'Допомагає розшифрувати архів у шифрі («ЦДІАК», «AGAD») і підказати, куди звертатися по справу. ' +
        'Це довідник, а не перелік архівів, по яких є записи в реєстрі: частина архівів записів не має, ' +
        'тож кількість архівів у довіднику нічого не каже про вміст реєстру.',
      inputSchema: {
  ...
  server.registerResource(
    ...
    {
      title: 'Довідник архівів',
      description: 'Довідник архівів і бібліотек (не лише тих, по яких є записи в реєстрі): скорочена й повна назва, країна, сайт.',
