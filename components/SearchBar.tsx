  ...
  return (
    <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 px-4 py-4 border-b border-gray-300">
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        {/* Права частина - Неідентифіковані інвентарі */}
        <div className="lg:w-80 flex flex-col justify-between gap-3 p-4 border border-gray-300 dark:border-gray-700 rounded bg-gray-50 dark:bg-gray-800">
          <div>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Не можете знайти інвентар? Спробуйте перевірити список неідентифікованих інвентарів.
            </p>
          </div>
          <button
            onClick={() => {
