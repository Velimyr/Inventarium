  ...
  server.registerTool(
    'search_inventories',
    {
      ...
      description:
        ...
        `«${L.total}» — кількість збігів тексту в назвах, примітках і шифрах, а не точна статистика: запит «ЦДІАК» ` +
        'знайде й записи, де архів лише згадано в примітках, тож для підрахунку записів архіву чи регіону він не придатний. ' +
